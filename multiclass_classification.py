...
def get_metrics(clf, X_train, X_test, X_test_full, y_train, y_test, y_test_full, metrics_filename, model_name,
    ...
    with open(Path('results/classifications_multi') / metrics_filename, 'w') as f:
        f.write('train\n')
        ...
        cm_filename = f"{dataset}_multiclass_cm_{xxx}.png"
    ...
    for model in models:
        if model == 'logistic':
            for solver in solvers:
                ...
                model_name = f'{model}_{dataset}_multi.pkl'
